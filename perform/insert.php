...
<?
    ...
    */
	...
	if ($mode=="modify")
	{
		...
		$sql = "update $table set subject='$subject', content='$content',period='$period',hours='$hour', palce='$place',
        age='$age' where num=$num";
		mysqli_query($conn , $sql);  // $sql 에 저장된 명령 실행
	}
	else
	{
        ...
        $sql = "INSERT INTO perform
(id, name, nick, subject, content, regist_day, hit, is_html, period, hours, palce, age, file_name_0, file_name_1, file_name_2, file_copied_0, file_copied_1, file_copied_2)
VALUES('$userid', '$username', '$usernick', '$subject', '$content', '$regist_day', 0, '$is_html', '$period', '$hour', '$place', '$age', '$upfile_name[0]', '$upfile_name[1]', '$upfile_name[2]', '$copied_file_name[0]', '$copied_file_name[1]', '$copied_file_name[2]')";
        
//		$sql = "insert into $table (id, name, nick, subject, content, regist_day, hit, is_html, period, hours, place, age ";
//		$sql .= ", file_name_0, file_name_1, file_name_2, file_copied_0,  file_copied_1, file_copied_2) ";
//		$sql .= "values('$userid', '$username', '$usernick', '$subject', '$content', '$regist_day', 0, '$is_html', '$period', '$hour', '$place', '$age'  ";
