...
<head>
    ...
    <link href="../perform/css/perform_list.css" rel="stylesheet" type="text/css" media="all">
    <script>
        function del(href) {
    ...
    <div id="wrap">
        ...
        <article id="content">
            ...
            <div id="view_title">
                ...
                <!--                <div id="view_title2"><?= $item_subject ?></div>-->
            </div>
...
?>
                ...
                <div class='content_in'><?=$item_content?></div>
                <div class="img_box">
<?
                
//                 echo"<div class='content_in'>$item_content</div>";    
                    
	for ($i=1; $i<3; $i++)  //업로드된 이미지를 출력한다
	{
		if ($image_copied[$i])
		{
