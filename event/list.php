...
<!-- 서브네비영역 -->
    <div class="subnav_box">
          ...
          <div class="subNav">
              <ul>
                  <li><a class="current" id="nav1" href="../event/list.php">고객의소리</a></li>
...
?>
			<ul id="list_item">
				<li id="list_item1" class="item"><?= $number ?></li>
				<li id="list_item2"><a href="view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>">
				
				<img src="<?=$item_img?>" alt=""> <!-- width 와 height css에 써라 -->
				</a></li>
                <li id="list_item3"><a href="view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>"><?= $item_subject ?></a></li>
...
<? 
	if($userid)//관리자의 아이디를 넣어서 관리자만 수정삭제글쓰기가 되도록한다. ($userid=='관리자의아이디')
	{
?>
