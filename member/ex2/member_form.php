...
<script>
   ...
   } //open => 새로운창 띄우는것 중요한것은 id 값을 넘겨주는 것=>check_id.php?id= 
   ...
   function check_input()
   {
      ...
      document.member_form.submit(); //폼요소값 전송.
   }
...
?>
	...
	<div id="col2">
		...
		<div id="form_join">
			...
			<div id="join2">
			<ul>
			<li><div id="id1"><input type="text" name="id" required></div><div id="id2"><a href="#"><img src="../img/check_id.gif" onclick="check_id()"></a></div><div id="id3">4~12자의 영문 소문자, 숫자와 특수기호(_) 만 사용할 수 있습니다.</div></li>
